...
export default function EditeAd() {
    ...
    const [ titleAr, setTitleAr ] = useState( state.title_ar );
    const [ titleEn, setTitleEn ] = useState( state.title_en );
    const [ descriptionAr, setDescriptionAr ] = useState( state.description_ar );
    const [ descriptionEn, setDescriptioeEn ] = useState( state.description_en );
    const [ tag, setTag ] = useState( state.tag );
    const [ validTo, setValidTo ] = useState( state.valid_to );
    ...
    return (
        ...
        <div className='container mt-5 mb-5 d-flex flex-column gap-4'>
            <Box sx={ { minWidth: 120 } }>
                <div className='my-4'>
                    <TextField id="outlined-basic" label="title-ar" variant="outlined" value={ titleAr } onChange={ ( e ) => setTitleAr( e.target.value ) } fullWidth />
                </div>
                <div className='my-4'>
                    <TextField id="outlined-basic" label="title-en" variant="outlined" value={ titleEn } onChange={ ( e ) => setTitleEn( e.target.value ) } fullWidth />
                </div>
                <div className='my-4'>
                    <TextField id="outlined-basic" label="description_ar" variant="outlined" value={ descriptionAr } onChange={ ( e ) => setDescriptionAr( e.target.value ) } fullWidth />
                </div>
                <div className='my-4'>
                    <TextField id="outlined-basic" label="description_en" variant="outlined" value={ descriptionEn } onChange={ ( e ) => setDescriptioeEn( e.target.value ) } fullWidth />
                </div>
                <div className='my-4'>
                    <TextField id="outlined-basic" label="tag" variant="outlined" value={ tag } onChange={ ( e ) => setTag( e.target.value ) } fullWidth />
                </div>
                <div className='my-4'>
